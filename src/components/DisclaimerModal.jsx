      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-3xl max-h-[90vh] bg-neutral-900 border border-neutral-800 shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Gold Accent Bar */}
            ...
            <div className="flex items-center justify-between px-8 py-6 border-b border-neutral-800 shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-lg font-serif font-bold tracking-wide">Full Disclaimer</h2>
            ...
            <div className="overflow-y-auto flex-1 px-8 py-8 space-y-8 scrollbar-thin">
              {/* Preamble */}
              <div className="bg-black/30 border border-neutral-800/60 p-6">
                <p className="text-neutral-400 text-sm leading-relaxed">
                  The following disclaimer governs your use of the website of <span className="text-white font-medium">Lex Prime Associates</span> ("the Firm"), a registered law firm operating in India under the Bar Council of India Rules. By accessing this website, you confirm that you have read, understood, and agree to be bound by the terms set out below.
                </p>
              </div>
              ...
              {DISCLAIMER_SECTIONS.map((section, i) => (
                <motion.div
                  ...
                  className="space-y-3"
                >
                  <h3 className="text-sm font-serif font-bold text-white tracking-wide">{section.title}</h3>
            ...
            {/* Footer Actions */}
            <div className="px-8 py-5 border-t border-neutral-800 flex items-center justify-between shrink-0">
              <p className="text-[10px] uppercase tracking-[0.3em] text-neutral-600">Lex Prime Associates · Est. 1994</p>
              <button
                onClick={onClose}
                className="flex items-center gap-2 px-6 py-2.5 border border-neutral-700 text-xs uppercase tracking-widest text-neutral-300 hover:bg-white hover:text-black hover:border-white transition-all duration-400"
              >
                Close
              </button>
            </div>
